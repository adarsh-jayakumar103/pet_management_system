...
<body>
    <div class="main">
        ...
        <span class="navbar-toggler-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
                        ...
                        <a class="navbar-brand mx-auto" href="index.html">Paw<span data-blast="color">Fect</span></a>
                        <div class="collapse navbar-collapse" id="navbarCollapse1">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="trial.html">Shop</a> </li>                                
                                <li class="nav-item"> <a class="nav-link" href="Cart.html">Cart</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="Pet1.php">Pets</a> </li>
    ...
    ================================================== -->
                ...
                <div class="swiper-container main-slider" id="myCarousel" data-blast="bgColor">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide slider-bg-position" style="background:url(images/bird2.jpg)" data-hash="slide1">
                        </div>
                        <div class="swiper-slide slider-bg-position" style="background:url(images/turtle1.jpg)" data-hash="slide2">
                        </div>
                        <div class="swiper-slide slider-bg-position" style="background:url(images/download2.png)" data-hash="slide3">
                        </div>
                        <div class="swiper-slide slider-bg-position" style="background:url(images/dog1.jpg)" data-hash="slide4">
                        </div>
                        <div class="swiper-slide slider-bg-position" style="background:url(images/download4.jpg)" data-hash="slide5">
                        </div>
                ...
                <div class="col-lg-3 about-in text-left">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text mt-3">We offer best play rooms for pets, to have a playful time
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 about-in text-left">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="line" data-blast="bgColor"></div>
                            <p class="card-text mt-3">Your pet's health, is our concern. We offer only high protein and quality foods.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 about-in text-left">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="line" data-blast="bgColor"></div>
                            <p class="card-text mt-3">Worried about your pet's vaccination? We have the best Veterinarian in town!!
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 about-in text-left">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="line" data-blast="bgColor"></div>
                            <p class="card-text mt-3">Book for any pet service with a few clicks:)
                            </p>
                        </div>
                    </div>
            ...
            <div class="inner-sec-w3layouts py-md-5 py-3">
                ...
                <div class="row choose-main mb-lg-4">
                    <div class="col-lg-6 galsses-grid-right">
                        ...
                        <h5>
                         ...
                         <!---->
                        <h4 class="post mt-3">Basic Bath</h4>
                        <div class="line" data-blast="bgColor"></div>
                        <p class="mt-3">1 hr</p>
                        <p class="mt-3">₹800</p>
                    ...
                    <div class="col-lg-6 galsses-grid-right">
                        <div class="galsses-grid-left">
                            <figure class="effect-lexi">
                                ...
                                <figcaption>
                                    <p data-blast="color">Basic Bath</p>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                ...
                <div class="row choose-main my-lg-4 my-3">
                    <div class="col-lg-6 galsses-grid-right mt-lg-4">
                        <div class="galsses-grid-left">
                            <figure class="effect-lexi">
                                <img src="images/groom.jpg" alt="" class="img-fluid">
                                <figcaption>
                                    
                                    <p data-blast="color">full Grooming</p>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-6 galsses-grid-right mt-4">
                        ...
                        <h4 class="post mt-3">FULL GROOM</h4>
                        <div class="line" data-blast="bgColor"></div>
                         <p class="mt-3">1hr 30min</p>
                         <p class="mt-3">₹1500</p>
                        <div class="log-in mt-md-4 mt-3">
                            <a class="btn text-uppercase" data-blast="bgColor" href="#book">
                             Book Now</a>
                ...
                <div class="row choose-main mb-lg-4">
                    <div class="col-lg-6 galsses-grid-right mt-lg-4">
                        ...
                        <h5>
                            <span class="post-color">21</span> May 2018</h5>
                         <!---->
                        <h4 class="post mt-3">Nail Trim</h4>
                        <div class="line" data-blast="bgColor"></div>
                        <p class="mt-3">30min</p>
                         <p class="mt-3">₹300</p>
                        <div class="log-in mt-md-4 mt-3">
                            <a class="btn text-uppercase" data-blast="bgColor" href="#book">
                             Book Now</a>
                    ...
                    <div class="col-lg-6 galsses-grid-right mt-lg-4">
                        <div class="galsses-grid-left">
                            <figure class="effect-lexi">
                                ...
                                <figcaption>
                                    <p data-blast="color">Nail Trim</p>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="inner-sec-w3layouts py-md-5 py-3">
                <div class="row choose-main">
                    <div class="col-lg-3">
                        <h3><small>Who We Are</small>About<br> Us</h3>
                    </div>
                    <div class="col-lg-4">
                        <p>Welcome to pawfect. Our great selection of products will cover all of your needs, whatever and wherever they may
                         be. Enjoy our exceptional shopping experience and contact our customer service with questions or comments</p>
                         <div class="col-lg-4">
            ...
            <div class="inner-sec-w3layouts py-md-5 py-3">
                <div class="choose-main">
                    <div id="search_form" class="search_top text-center">
                        <form action="booking.php" method="POST" class="booking-form row">
                            ...
                            <div class="col-md-3 banf">
                                <select id="country13" class="form-control" id="service" name="service">
                ...
                <div class="choose-main row">
                    <div class="col-md-4">
                        <h3><small>Find Us</small> Contact Us</h3>
                            <div class="map mt-3">
                            <iframe src="https://maps.google.com/maps?q=christ%20university&t=&z=19&ie=UTF8&iwloc=&output=embed" allowfullscreen=""></iframe>
