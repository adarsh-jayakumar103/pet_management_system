...
<body>
    <div class="main">
        ...
        <span class="navbar-toggler-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
                        ...
                        <a class="navbar-brand mx-auto" href="home.php">Paw<span data-blast="color">Fect</span></a>
                    ...
                    <div class="container">
                        <div class="inner-sec-w3layouts py-md-5 py-3">
                            <div class="choose-main row">
                                <div class="col-md-4">
                                    <h2 align="left" textstyle="Normal" style="border-color: #000" > PetList </h2>        
                                    <div class = "container">    
                                        <div class="row">
                                            <div class="col-md-12">
												<?php
												...
												{
													$sqlget = "SELECT * from pet_list";
													$sqldata = mysqli_query($conn, $sqlget) or die('error getting while displaying');

													echo "<table align='center'>";
													echo "<tr><th>ID</th><th>Category</th><th>Breed</th><th>Color</th><th>Age</th></tr>";
